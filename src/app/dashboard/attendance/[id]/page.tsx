...
export default function DealerAdminAttendanceDetailPage() {
  ...
  const [branchName, setBranchName] = useState<string>('Headquarters')
  ...
  useEffect(() => {
    ...
    fetchDetails()
  }, [id, adminProfile, supabase, router, addToast])
      ...
      <div className="bg-white border border-slate-200 rounded-[3rem] p-6 md:p-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div className="space-y-3">
          <div className="flex items-center gap-3 flex-wrap">
            <span className="text-[10px] text-slate-400 font-bold uppercase tracking-wider">Global Verification Log</span>
            <span
