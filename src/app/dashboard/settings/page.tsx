...
export default function SettingsPage() {
  ...
  return (
    <div className="space-y-8">
          ...
          {TABS.map(tab => {
            ...
            return (
              <button
                ...
                className={`
                  border-b-2 py-4 px-1 text-sm font-medium transition-all cursor-pointer whitespace-nowrap flex-1 sm:flex-initial text-center sm:text-left
                  ${isActive
      ...
      <div className="bg-white border border-slate-200 rounded-none p-8 md:p-12 space-y-8">
        {activeTab === 'branding' && (
