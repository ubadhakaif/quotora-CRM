...
import { Building2, Users, Car, Landmark, BarChart3, Settings, ArrowRight, IndianRupee, Target, FileText, Clock } from 'lucide-react'
...
const quickLinks = [
  ...
  },
  {
    ...
    label: 'Attendance',
    description: 'Audit employee check-in logs',
    icon: Clock,
  },
  {
